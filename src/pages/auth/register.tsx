        ...
        <Card className="w-full p-10 shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-none border border-default-200 bg-surface/60 backdrop-blur-xl rounded-[2.5rem]">
          <Card.Header className="flex justify-center pb-6 pt-2 px-0 flex-col items-center gap-2">
            ...
            <Card.Description className="text-muted font-medium text-sm text-center">
              Enter your details to start using RoomSync
            </Card.Description>
          </Card.Header>
          ...
          <Card.Content className="py-4 px-0">
            <form className="flex flex-col gap-6" onSubmit={handleRegister}>
              ...
              <Button
                className="mt-4 h-14 text-base font-black rounded-2xl shadow-xl shadow-secondary/30 transition-all active:scale-95"
                isPending={loading}
                type="submit"
                variant="secondary"
              >
