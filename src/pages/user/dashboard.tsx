    ...
    const fetchData = async () => {
      try {
        ...
        const facilities: Facility[] =
          facilitiesRes.data.data?.facilities || facilitiesRes.data.data || [];
    ...
    <div className="flex flex-col gap-10 max-w-6xl mx-auto py-8 px-4">
      ...
      <div className="relative overflow-hidden rounded-[3rem] bg-primary p-8 md:p-12 text-primary-foreground shadow-2xl shadow-primary/30">
        ...
        <div className="relative z-10 flex flex-col gap-6 max-w-2xl">
          ...
          <div className="flex gap-3">
            <Button
              className="h-14 px-8 rounded-2xl bg-primary-foreground text-primary font-black text-base shadow-xl hover:scale-105 transition-transform"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          <Card
            key={i}
            className="p-6 border border-default-200 bg-background/60 backdrop-blur-md hover:shadow-xl transition-all group overflow-hidden"
          >
            <div
            ...
            <div className="flex items-center gap-4">
              <div
                className={`p-4 rounded-2xl bg-${stat.color}/10 text-${stat.color}`}
              >
                <stat.icon size={24} />
              </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <Card className="p-8 border border-default-200 bg-background/60 backdrop-blur-md rounded-[2.5rem]">
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <p className="text-muted font-medium mt-2 max-w-xs">
